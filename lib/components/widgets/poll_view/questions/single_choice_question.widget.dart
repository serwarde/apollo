...
class _SingleChoiceQuestionWidget extends State<SingleChoiceQuestionWidget> {
  ...
  Widget _buildResult(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        context.debug(context.lang('poll.results.question') + ' ${widget.state.questionId}, ' + context.lang('poll.results.total_votes') + ' $total');
  ...
  Widget _buildParticipationOptions(BuildContext context) => Column(
    children: [
      ...widget.state.options.listEntries().map<Widget>((e) => Column(
            children: [
